-----------------------------------
-- Tear Grenade (Orc Warmachines)
-- Deals Water damage in an area of effect and blind + silence.
-----------------------------------
...
mobskillObject.onMobWeaponSkill = function(target, mob, skill)
    ...
    xi.mobskills.mobStatusEffectMove(mob, target, xi.effect.BLINDNESS, 20, 0, 45)
