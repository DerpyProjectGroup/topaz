...
zones[xi.zone.EAST_RONFAURE_S] =
{
    text =
    {
        ...
        DIG_THROW_AWAY                = 7754, -- You dig up <item>, but your inventory is full. You regretfully throw the <item> away.
        FIND_NOTHING                  = 7756, -- You dig and you dig, but find nothing.
    },
